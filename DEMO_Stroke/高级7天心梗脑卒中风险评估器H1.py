...
class Advanced7DayRiskAssessment:
    ...
    def assess_risk(self, data: Dict) -> Dict:
        ...
        try:
            ...
            # 获取风险等级
            mi_risk_level = self.get_risk_level(final_mi_score)
            stroke_risk_level = self.get_risk_level(final_stroke_score)
            ...
            return {
                ...
                'risk_prediction': {
                    'myocardial_infarction': {
                        ...
                        '7_day_risk_level': self.get_risk_level(final_mi_score),
                    ...
                    'stroke': {
                        ...
                        '7_day_risk_level': self.get_risk_level(final_stroke_score),
...
def parse_arguments():
    ...
    parser.add_argument('-o', '--output', 
                       default='./risk_results_1',
                       help='输出结果目录路径（支持相对路径，默认: ./risk_results_1）')

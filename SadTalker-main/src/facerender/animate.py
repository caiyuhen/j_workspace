...
from src.facerender.modules.make_animation import make_animation, AnimateModel
...
class AnimateFromCoeff():
    ...
    def __init__(self, sadtalker_path, device):
        ...
        self.animate_model = AnimateModel(self.generator, self.kp_extractor, self.mapping, self.he_estimator)
        if torch.cuda.is_available() and torch.cuda.device_count() > 1:
            self.animate_model = torch.nn.DataParallel(self.animate_model)
        self.animate_model = self.animate_model.to(device)
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', img_size=256):
        ...
        predictions_video = self.animate_model(model_input)

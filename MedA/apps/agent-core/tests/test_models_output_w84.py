...
def test_rule_O1_locked_cannot_change_domains_literal_exact():
    from app.services.output_stage import _simulate_rule_O1, OutputStageError
...
def test_rule_O2_grade_requires_completed_meta_analysis_literal():
    from app.services.output_stage import _simulate_rule_O2, OutputStageError
    with pytest.raises(OutputStageError) as ei:
...
def test_rule_O5_no_grade_report_requires_at_least_one_literal():
    from app.services.output_stage import _simulate_rule_O5, OutputStageError
    with pytest.raises(OutputStageError) as ei:
...
def test_rule_O6_incomplete_missing_content_sections_literal():
    from app.services.output_stage import _simulate_rule_O6_incomplete, OutputStageError
    with pytest.raises(OutputStageError) as ei:
...
def test_rule_O7_prisma_locked_cannot_change_items_literal():
    from app.services.output_stage import _simulate_rule_O7, OutputStageError
    with pytest.raises(OutputStageError) as ei:
...
def test_rule_O8_grade_invalid_domain_count_require_exact_5_keys_literal():
    from app.services.output_stage import _simulate_rule_O8, OutputStageError
    with pytest.raises(OutputStageError) as ei:

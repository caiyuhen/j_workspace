...
此模板提供了一个最小化的设置，用于在 Vite 中使 React 与 HMR (热模块替换) 和一些 ESLint 规则一起工作。
...
由于 React Compiler 对开发和构建性能的影响，此模板默认未启用它。要添加它，请参阅 [此文档](https://react.dev/learn/react-compiler/installation)。
